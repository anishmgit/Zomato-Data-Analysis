...
## Project Overview
This project explores Zomato restaurant data to analyze customer preferences,
...
- `data/zomato.csv` – Dataset used for analysis

## Conclusion
The insights from this analysis help understand customer behavior and
restaurant performance, enabling Zomato to design targeted offers and
improve customer satisfaction across ordering modes.
